    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                {"role": "system",
                 "content":
                    """You are a network graph maker who extracts terms and their relations from a given Vietnamese context.
                    The purpose of the Knowledge graph will be to structure Vietnamese legal areas for later query purposes.
